...
**Figure 1. Trout perch data frame missing value visualization throughout all years.** Variables on the y axis of trout perch collected from North Temperate Lakes LTER. X axis represents the number of missing data points from each of the variables. Sex, flag, fishpart, sampletype, and weight all have missing data points.
